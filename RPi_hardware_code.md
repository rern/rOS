...
|         |           |       |        |           |                  |          |          |
| **ARMv6Z** (32bit)                                                                        |
| Zero    | `09`      | :no_entry: | :no_entry: | BCM2835   | ARM1176JZF-S x 1 | 1        | `0`      |
| Zero W  | `0c`      |       | :no_entry: | ↑         | ↑                | ↑        | ↑        |
| A+      | `02`      | :no_entry: | :no_entry: | ↑         | ↑                | ↑        | ↑        |
| B+      | `03`      | :no_entry: |        | ↑         | ↑                | ↑        | ↑        |
|         |           |       |        |           |                  |          |          |
| **ARMv7-A** (32bit)                                                                       |
| 2B      | `04`      | :no_entry: |        | BCM2836   | Cortex-A7 x 4    | 0.9      | `1`      |
|         |           |       |        |           |                  |          |          |
| **ARMv8-A** (64/32bit)                                                                    |
| Zero 2W | `12`      |       | :no_entry: | RP3A0     | Cortex-A53 x 4   | 1        | `2`      |
|         |           |       |        |           |                  |          |          |
| 2B 1.2  | `04`      | :no_entry: |        | BCM2837   | ↑                | 0.9      | ↑        |
| 3B      | `08`      |       |        | ↑         | ↑                | 1.2      | ↑        |
|         |           |       |        |           |                  |          |          |
| 2B 1.3  | `04`      | :no_entry: |        | BCM2837B0 | ↑                | 0.9        | ↑        |
| 3A+     | `0e`      | +5GHz | :no_entry: | ↑         | ↑                | 1.4      | ↑        |
| 3B+     | `0d`      | ↑     | Gbit   | ↑         | ↑                | ↑        | ↑        |
|         |           |       |        |           |                  |          |          |
