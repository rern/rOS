...
- PC - Any Linux distros:
	- With any package manager: `apk` `apt` `brew` `dnf` `pacman` `yum` `zypper`
	- Live USB can be used as well e.g.,
		- GUI
			...
			- [Linux Mint](https://linuxmint.com/download.php) (2.9GB) - Light modern
		...
		- Recommend - ISO bootable USB drive with [Ventoy](https://www.ventoy.net)
			...
			```
			- Copy `*.iso` to drive/partition labelled `Ventoy`
			- Reboot to USB
