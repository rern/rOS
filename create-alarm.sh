...
10 "$upmpdcli" on )
	...
	[[ $select == *' 2 '* ]] && features+='camilladsp camillagui python-aiohttp python-pycamilladsp python-pycamilladsp-plot python-jsonschema 
											python-matplotlib python-numpy python-websocket-client python-websockets ' && list+="$camilla"$'\n'
