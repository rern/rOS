...
10 "$upmpdcli" on )
	...
	[[ $select == *' 2 '* ]] && features+='git python-aiohttp python-jsonschema python-matplotlib python-numpy python-pip python-websockets python-websocket-client python-wheel unzip ' && list+="$camilla"$'\n'
