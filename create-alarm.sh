...
10 "$upmpdcli" on )
	...
	[[ $select == *' 2 '* ]] && features+='python-aiohttp python-jsonschema python-matplotlib python-numpy python-pip python-websockets python-websocket-client unzip ' && list+="$camilla"$'\n'
