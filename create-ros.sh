...
if [[ ${hawrevision: -3:2} == 11 ]]; then
	curl -Lo raspberrypi-bootloader-20201129-1-any.pkg.tar.xz https://github.com/rern/rern.github.io/raw/master/archives/raspberrypi-bootloader-20201129-1-any.pkg.tar.xz
	wget -Lo raspberrypi-bootloader-x-20201129-1-any.pkg.tar.xz https://github.com/rern/rern.github.io/raw/master/archives/raspberrypi-bootloader-x-20201129-1-any.pkg.tar.xz
