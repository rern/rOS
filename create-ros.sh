...
wget -q --show-progress https://github.com/rern/rOS/archive/master.zip -O config.zip
wget -q --show-progress https://github.com/rern/rOS-$version/archive/$uibranch.zip -O ui.zip
mkdir -p /tmp/config
