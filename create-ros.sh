...
gcc glibc gifsicle hdparm hfsprogs i2c-tools imagemagick inetutils iwd jq kid3-common
libgpiod linux-rpi mmc-utils mpc mpd mpd_oled nfs-utils nginx-mainline nss-mdns parted php-fpm pkgconf
python-rpi-gpio python-rplcd python-smbus2 python-websocket-client python-websockets
...
for n in amdgpu broadcom intel liquidio marvell mellanox nfp nvidia qcom qlogic radeon linux-aarch64 linux-firmware uboot-raspberrypi; do
